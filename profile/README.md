![SonicDE on Arch Linux](https://github.com/sonicde-arch/sonicde-arch/blob/master/docs/img/screenshot.jpg)
...
Please see our homepage on [**how to install and use**](https://sonicde-arch.github.io/) the packages.
